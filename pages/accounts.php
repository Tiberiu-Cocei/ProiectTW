...
<div class="textWrapper">
    ...
    <button onclick="location.href = '#copyPassword';" id="copyPassword1" type="button"
            class="button buttonMargin"><b>Copy to clipboard</b></button>
    ...
    <button onclick="location.href = '#edit';" id="edit1" type="button"
