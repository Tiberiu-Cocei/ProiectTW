...
<h1 class="text-center"><u><b>Add new account</b></u></h1>
    <div class="text-center center">
        <form action="./new_account_action.php" method="POST">
            ...
            <input type="text"    name="address"  placeholder="Web adress for site"   class="form-control dataField"  value="<?php if (isset($_COOKIE['address']))  echo $_COOKIE['address'];?>" >
