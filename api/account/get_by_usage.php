<?php
//fisierul asta returneaza toate conturile unui utilizator sortate dupa contorul de utilizari
/*
  Cum se foloseste api-ul asta: metoda GET, link-ul http://localhost/api/account/get_by_usage.php?id_utilizator=aiciIdul
*/
